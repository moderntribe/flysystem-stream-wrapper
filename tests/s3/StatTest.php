 ...
 *
 * @package Tribe\Storage\Tests\s3
 */
class StatTest extends StreamWrapperTestCase {
	...
	protected function setUp(): void {
		...
		// Define the WordPress constant that the stream wrapper will use
		// to make all directories return as if they're there
		// because WordPress does a file_exists when testing the upload_directory
		define( 'ABSPATH', '/tmp' );

		copy( tribe_wrapper_dir( 'testfile.txt' ), $this->file );
		mkdir( $this->dir );
	}
