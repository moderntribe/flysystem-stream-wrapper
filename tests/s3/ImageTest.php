...
class ImageTest extends StreamWrapperTestCase {
	...
	protected function setUp(): void {
		...
		$this->image                  = 'fly://image-with-exif-data.jpg';
		$this->image_with_broken_exif = 'fly://images/image-with-corrupt-exif-data.jpg';

		mkdir( 'fly://images' );
		copy( tribe_wrapper_dir( 'images/subdir/image-with-exif-data.jpg' ), $this->image );
		copy( tribe_wrapper_dir( 'images/image-with-corrupt-exif-data.jpg' ), $this->image_with_broken_exif );
	}
